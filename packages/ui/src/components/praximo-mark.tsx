 ...
 * component is that artwork's only entry into the interface, so replacing it when the
 * masters change is one file.
 *
 * **No disc.** The mark is a complete lockup — an orbit around a figure,
 * reaching a point. The transparent masters are cut for exactly this —
 ...
 * is provided by the consuming application's host or browser preference.
 */
