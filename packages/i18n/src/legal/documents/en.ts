 ...
 * are identified by is derived from it, and the other two locales are
 * translations *of* it rather than independent documents (#130).
 */
...
export const coachTermsEn: LegalDocument = {
