  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        // `locale` is spread conditionally rather than passed through: this
        // repository compiles with `exactOptionalPropertyTypes`, under which an
        // optional prop and an explicit `undefined` are different types.
        DayButton: ({ ...dayProps }) => (
          <CalendarDayButton {...(locale === undefined ? {} : { locale })} {...dayProps} />
        ),
