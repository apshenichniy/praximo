    ...
    <>
      ...
      <ul className="mt-4 flex flex-col gap-2.5">
        {deletionConsequences(workspace).map((consequence) => (
          <li key={consequence} className="flex gap-2.5 text-base leading-relaxed leading-5">
    ...
    <>
      ...
      <div className="mt-7 flex flex-col gap-2">
        <Button
          ...
          className="bg-destructive text-background hover:bg-destructive/90 h-13 w-full text-base leading-snug font-semibold"
          onClick={onConfirm}
        >
