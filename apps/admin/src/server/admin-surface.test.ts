...
describe("AdminSurface", () => {
  ...
  it.effect("telegram action: creates the invite only — the share is a follow-up step", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(result.link).toContain("https://t.me/PraximoBot?start=ws_")
      ...
      expect(prepared).toEqual([
        {
          ...
          invite: {
            ...
            buttonUrl: "https://t.me/PraximoBot?start=ws_ADA23456",
          },
        },
      ])
  ...
  it.effect("presents a pending invite with its channel, link, and forwardable message", () =>
    Effect.gen(function* () {
      ...
      expect(detail.invite?.link).toContain("https://t.me/PraximoBot?start=ws_")
