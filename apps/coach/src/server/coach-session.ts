...
export class Service extends Context.Service<Service, Interface>()("@praximo/coach/CoachSession") {}
 ...
 *
 * This composition lives in `apps/coach` rather than in a package because it joins
